...
import 'package:front_flutter/screens/dog/single_dog_screen.dart';
  ...
  List<AutoRoute> get routes => [
        AutoRoute(path: '/', page: BottomBarRoute.page, children: [
          ...
          AutoRoute(path: 'dogs', page: DogsRouter.page, children: [
            ...
            CustomRoute(path: ':dogId', page: SingleDogRoute.page, transitionsBuilder: TransitionsBuilders.noTransition)
          ]),
